...
HD_PWD='C:/Users/lizheng/Desktop/VivadoLab/LAB2/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalTimer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DigitalTimer.tcl
