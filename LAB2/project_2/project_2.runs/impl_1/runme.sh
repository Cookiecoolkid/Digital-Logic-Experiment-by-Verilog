...
HD_PWD='C:/Users/lizheng/Desktop/VivadoLab/LAB2/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalTimer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DigitalTimer.tcl -notrace
