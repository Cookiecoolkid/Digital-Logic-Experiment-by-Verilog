...
HD_PWD='C:/Users/lizheng/Desktop/VivadoLab/LAB1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_32bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_32bit.tcl
