...
HD_PWD='C:/Users/lizheng/Desktop/VivadoLab/LAB5/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyboardSim.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KeyboardSim.tcl
