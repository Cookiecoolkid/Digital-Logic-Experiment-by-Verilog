...
HD_PWD='C:/Users/lizheng/Desktop/VivadoLab/LAB5/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyboardSim.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source KeyboardSim.tcl -notrace
